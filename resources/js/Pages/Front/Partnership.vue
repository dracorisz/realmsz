...
<template>
  <FrontLayout title="Partnership" :hasHero="true">
    <template #content>
      <div class="flex w-full flex-col z-10 bg-gradient-to-bl px-10 from-primary/10 to-accent/5 py-20 text-white">
        <div class="mx-auto flex w-full max-w-7xl ah-[144px] justify-start px-10 items-center text-white">
        ...
        <div class="heading-3 mx-auto flex w-full max-w-7xl flex-col justify-start px-10 text-left my-10">
          ...
          <div class="form-inner-container ml-20 mr-auto self-start">
            <form class="form relative z-30 w-full" action="#">
              <div class="form-toggle text-white">
                <PrimaryButton :onlyIcon="true" color="#000">
                  <template #icon>
              ...
              <div class="mt-4 flex w-full items-end justify-end">
                <PrimaryButton @click="console.log('send email partner')">
                  <template #icon>
...
.form-inner-container {
  @apply relative opacity-0 transition-all ease-in-out will-change-transform duration-[1.5s] ah-[310px] aw-[377px];
  transform-style: preserve-3d;
}
...
.form {
  @apply absolute left-0 z-30 w-full rounded-2xl bg-black bg-gradient-to-tr from-primary/30 to-accent/30 p-10;
}
