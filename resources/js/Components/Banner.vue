...
<template>
  <div>
    <div v-if="show && message" :class="{ 'bg-success': style == 'success', 'bg-warning': style == 'danger' }">
      <div class="max-w-(--breakpoint-xl) mx-auto py-2 px-10">
        <div class="flex items-center justify-between flex-wrap">
          <div class="w-0 flex-1 flex items-center min-w-0">
            <span class="flex p-2 rounded-2xl" :class="{ 'bg-success': style == 'success', 'bg-warning': style == 'danger' }">
          ...
          <div class="shrink-0 sm:ml-3">
            <button type="button" class="-mr-1 flex p-2 rounded-2xl sm:-mr-2 transition" :class="{ 'hover:bg-success focus:bg-success': style == 'success', 'hover:bg-warning focus:bg-warning': style == 'danger' }" aria-label="Dismiss" @click.prevent="show = false">
